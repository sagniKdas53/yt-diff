                    ...
                    (async () => {
                        try {
                            ...
                            const onClose = () => {
                                ...
                                try { readStream.destroy(); } catch (error) { logger.error("Error destroying read stream on client disconnect", { error: error && error.message, fileId }) };
                            };
                            ...
                            try {
                                ...
                                try { res.end('Error reading file'); } catch (e) { logger.error("Error ending response after streaming failure", { error: e && e.message, fileId }); }
                            } finally {
